...
class DNN():
    ...
    def forward(self, x, epoch, iteration):
        self.Zs = []
    ...
    def backward(self, y, epoch, iteration):
    ...
    def train(self, epochs):
        ...
        for epoch in tqdm(range(epochs)):
            ...
            for iteration, data in enumerate(train_loader):
                ...
                preds = self.forward(data[0], epoch, iteration)
                nvtx.range_pop()
                ...
                grads_W, grads_b = self.backward(data[1], epoch, iteration)
